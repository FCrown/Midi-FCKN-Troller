...
public class SoundModel {
   ...
   //5th Row Sound
    private AudioClip s20 = new AudioClip(new File("src\\midifckn\\soundFiles\\leadPopsLoops.wav").toURI().toString());
    private AudioClip s21 = new AudioClip(new File("src\\midifckn\\soundFiles\\majorPluckCmLoop.wav").toURI().toString());     
    private AudioClip s22 = new AudioClip(new File("src\\midifckn\\soundFiles\\trapLoop4.wav").toURI().toString());
    private AudioClip s23 = new AudioClip(new File("src\\midifckn\\soundFiles\\organLead.wav").toURI().toString());
    private AudioClip s24 = new AudioClip(new File("src\\midifckn\\soundFiles\\drop.wav").toURI().toString());  
    //Tracks
